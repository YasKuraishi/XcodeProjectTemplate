...
// Sculptor
#define COCOAPODS_POD_AVAILABLE_Sculptor
#define COCOAPODS_VERSION_MAJOR_Sculptor 0
#define COCOAPODS_VERSION_MINOR_Sculptor 3
#define COCOAPODS_VERSION_PATCH_Sculptor 0
